...
function Model() {
  // Menggunakan model red_label sesuai permintaanmu
  const { scene } = useGLTF('/assets/red_label/scene.gltf');
  return <primitive object={scene} scale={1.8} position={[0, -0.8, 0]} />;
}

export default function BeerWine3D() {
  return (
    <Suspense fallback={null}>
      ...
      >
        ...
        <Environment preset="night" /> {/* Preset night cocok untuk tema botol/alkohol */}
