      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-12">
        <div className="flex flex-col md:flex-row justify-between items-start space-y-8 md:space-y-0">
          ...
          <div className="flex-1 space-y-6">
            {/* Created By */}
            <div>
              <h1 className="text-lg font-bold text-light-green mb-2">Created By</h1>
              <p className="font-hind text-sm">This website was created for Codédex Summer Hackathon 2024 by Bratee, Aditya, and Ritwik.</p>
            </div>

            {/* Contact Us */}
            <div>
              <h1 className="text-lg font-bold text-light-green mb-2">Contact Us</h1>
          ...
          <div className="flex-1">
            <h1 className="text-lg font-bold text-light-green mb-2">Location</h1>
